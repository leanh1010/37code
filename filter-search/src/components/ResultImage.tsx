...
const ResultImage = ({ ImageList }: OptionPros) => {
    return (
        <div className="list-rank">
            ...
            <a href={ResultLinks[index]} target="_blank" attr-filter1={Filter1[index]} attr-filter2={Filter2[index]} attr-filter3={Filter3[index]} 
                    attr-filter4={Filter4[index]} attr-filter5={Filter5[index]} attr-filter6={Filter6[index]} >
                <img src={image} alt={ResultImagesAlt[index]} />
            </a>
            ))}
        </div>
    )
